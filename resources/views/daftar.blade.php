<x-layouts.applogin>
    ...
    <section class="p-3 p-md-4 p-xl-5">
        <div class="container mb-5">
            ...
            @endsession
            @session('error')
                <div id="alert-error" class="zindex alert alert-danger alert-dismissible fade show position-fixed top-50 start-50 translate-middle" x-transition role="alert">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-body p-5 p-md-4 p-xl-5">
                            ...
                            <div x-data="{ isSubmitting: false }">
                                <form x-on:submit="isSubmitting = true" action="{{ url('daftar') }}" method="POST">
                                    @method('POST')
                                    @csrf
                                    <div class="row gy-3 gy-md-4 overflow-hidden">
                                        <div class="col-12">
                                            <label for="name" class="form-label">Nama Lengkap (PIC) <span class="text-danger">*</span></label>
                                            <input type="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="{{ old('nohp') }}" type="nohp" inputmode="numeric" class="form-control @error('nohp') is-invalid @enderror" name="nohp"
                                                    id="nohp" placeholder="No HP" required>
                                            </div>
                                            @error('nohp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex">
                                                <select name="type_company" class="form-select typecompany" required>
                                                    <option value="">Pilih</option>
                                                    <option value="CV" {{ old('type_company') == 'CV' ? 'selected' : '' }}>CV</option>
                                                    <option value="PT" {{ old('type_company') == 'PT' ? 'selected' : '' }}>PT</option>
                                                </select>
                                                <input value="{{ old('name_company') }}" name="name_company" type="name_company" class="form-control @error('name_company') is-invalid @enderror"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="commodity_id" class="form-select" required>
                                                ...
                                                @foreach ($commodities as $item)
                                                    <option value="{{ $item->id }}" {{ old('commodity_id') == $item->id ? 'selected' : '' }}>{{ $item->name_commodity . ' - ' . $item->group }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('commodity_id')
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <select name="region_id" class="form-select" required>
                                                ...
                                                @foreach ($all_kab as $kab)
                                                    <option value="{{ $kab->id }}" {{ old('region_id') == $kab->id ? 'selected' : '' }}>{{ $kab->name_region }}</option>
                                                @endforeach
                                            </select>
                                            @error('region_id')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input value="{{ old('username') }}" autocomplete="off" type="username" class="form-control @error('username') is-invalid @enderror" name="username"
                                        ...
                                        <div class="col-12" x-data="{ show: true }">
                                            ...
                                            <div class="input-group">
                                                <input name="password" :type="show ? 'password' : 'text'" class="form-control @error('password') is-invalid @enderror" id="password"
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-primary" type="submit" x-show="!isSubmitting">
                                                    <i class="bi bi-box-arrow-in-right"></i> D A F T A R
                                                </button>
