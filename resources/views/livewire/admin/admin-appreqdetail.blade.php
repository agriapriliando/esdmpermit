                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div>
                                <div class="p-3 bg-success text-bg-success rounded mb-2">
                                    <h4>Permohonan ini telah selesai, dokumen bisa dicetak</h4>
                                </div>
                                            ...
                                            <div class="p-3 rounded shadow" x-data="{ open: false }">
                                                ...
                                                <div>
                                                    ...
                                                    @foreach ($correspondences as $c)
                                                        <div wire:key="{{ $c->id }}" class="px-3 pb-2 rounded {{ $c->user->role == 'admin' ? 'text-end bg-body-secondary' : '' }}">
                                                            <p>
                                                                ...
                                                                @endif
                                                                <br>
                                                                Pengirim : {{ $c->user->name == 'Admin Utama' ? 'Saya' : $c->user->name }}
                                                                <br>
                                                                Pesan : {!! $c->desc !!}
                                                            </p>
                                                        </div>
